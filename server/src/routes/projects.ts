...
import { type AppEnv, authMiddleware, memberOnly, ownerOnly } from "../middleware.js";
import {
...
import { AddMemberSchema, CreateProjectSchema, ResolvePendingSchema } from "../schemas.js";
...
projects.post(
  "/api/projects/:id/resolve-pending",
  memberOnly,
  vValidator("json", ResolvePendingSchema),
  async (c) => {
    const projectId = c.req.param("id");
